...
// import TestprofilePic from "../assets/kevinRushProfile.png";
                ...
                <div className='w-full lg:w-1/2'>
                    <div className='flex flex-col items-center lg:items-start'>
                        <motion.h1 variants={Container(0)}
                            initial="hidden"
                            animate="visible"
                            className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl">Ashish Thatipelli</motion.h1>
                        <motion.span
                ...
                <div className='w-full lg:w-1/2 lg:p-8'>
                    <div className='flex justify-center'>
                        <motion.img
                            ...
                            src={profilePic} alt=" " className='rounded-2xl' />
                    </div>
                </div>
            </div>
        </div>
